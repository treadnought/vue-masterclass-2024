...
import { projectQuery } from '@/utilities/supaQueries'
import type { Project } from '@/utilities/supaQueries'
...
.table-container {
    @apply overflow-hidden overflow-y-auto rounded-md bg-white h-80;
}
</style>
<style scoped></style>
